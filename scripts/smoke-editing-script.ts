...
async function main(): Promise<void> {
  ...
  try {
    ...
    console.log(`Framing markers: ${JSON.stringify({ count: framingMarkerCount, label: framingMarkerLabel ?? '' })}`)
    ...
    if (framingMarkerCount < 1 || !framingMarkerLabel) process.exitCode = 1
