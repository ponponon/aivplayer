  export const jaJP = {
    ...
    editing: {
      cornerBottomRight: '右下コーナー', cornerTopLeft: '左上コーナー', splitLeft: '左分割', splitRight: '右分割', treatmentSize: '構図サイズ', framingOrientationHint: '縦長→コーナー · 横長/正方形→分割', recommended: '推奨',
