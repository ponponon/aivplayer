...
export type MediaProbeMetadata = { fileSizeBytes: number; fileMtimeMs?: number; durationSeconds: number | null; overallBitrateKbps: number | null; video: MediaVideoMetadata | null; audio: MediaAudioMetadata | null; chapters: MediaChapter[]; probeSource: 'ffprobe' | 'ffmpeg' | null; details: MediaProbeDetails | null }
...
export type MediaWaveformRequest = { mediaPath: string; width?: number; height?: number; useCache?: boolean }
export type MediaWaveformResult = { success: boolean; message: string; dataUrl?: string; cacheHit: boolean; generated: boolean; cacheKey: string | null }
