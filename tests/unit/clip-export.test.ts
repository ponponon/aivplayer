...
describe('clip export helpers', () => {
  ...
  it('builds a timeline output name and concat command', () => {
    ...
    expect(buildTimelineExportDefaultFileName('/clips/demo.mp4', 2, 10.8, 'subtitle-vtt')).toBe('demo-timeline-2clips-10s-source.vtt')
    expect(buildTimelineExportDefaultFileName('/clips/demo.mp4', 2, 10.8, 'translation-ass')).toBe('demo-timeline-2clips-10s-translation.ass')
    ...
    expect(normalizeTimelineExportFileName('用户剪辑/我的视频.srt', 'fallback.ass', 'translation-ass')).toBe('我的视频.ass')
