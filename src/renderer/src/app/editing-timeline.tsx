...
import { EditingTreatmentControl } from './editing-treatment-control'; import { EditingFilterControl } from './editing-filter-control'; import { EditingTransitionControl } from './editing-transition-control'; import { EditingGraphicControl } from './editing-graphic-control'
  ...
  return (
    <section className="editing-timeline" data-testid="editing-timeline" aria-label={app.copy.editing.timelineLabel}>
      ...
      <div className="editing-action-row">
        ...
        <EditingCaptionLayoutControl title={app.copy.editing.captionLayoutTitle} xLabel={app.copy.editing.captionLayoutX} yLabel={app.copy.editing.captionLayoutY} widthLabel={app.copy.editing.captionLayoutWidth} sizeLabel={app.copy.editing.captionLayoutSize} resetLabel={app.copy.editing.captionLayoutReset} value={captionLayout} onChange={app.setEditingCaptionLayout} />
        ...
        <EditingGraphicEditor graphic={selectedGraphic} title={app.copy.editing.graphicEditTitle} textLabel={app.copy.editing.graphicText} textPlaceholder={app.copy.editing.graphicPlaceholder} saveLabel={app.copy.editing.graphicSave} positionLabel={app.copy.editing.graphicPosition} styleLabel={app.copy.editing.graphicStyle} titleStyleLabel={app.copy.editing.graphicStyleTitle} labelStyleLabel={app.copy.editing.graphicStyleLabel} durationLabel={app.copy.editing.graphicDuration} assetSaveLabel={app.copy.editing.assetSaveLabel} positionLabels={app.copy.editing.graphicPositionLabels} timelineDuration={durationSeconds} onSaveAsset={saveElementAsset} onUpdate={app.updateEditingGraphic} />
