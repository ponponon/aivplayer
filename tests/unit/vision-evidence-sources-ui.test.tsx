...
describe('vision evidence sources UI', () => {
  ...
  it('keeps source management actions connected to the generic preload API', async () => {
    ...
    const component = await readFile(join(projectRoot, 'src/renderer/src/app/vision-evidence-sources.tsx'), 'utf8')
    ...
    expect(component).toContain('vision-evidence-load-more')
    expect(component).toContain('evidenceSourcesLoadMore')
