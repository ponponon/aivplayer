...
describe('vision clip collection batch merge UI wiring', () => {
  it('exposes a guarded action that keeps the source collections', () => {
    ...
    expect(panel).toContain('updateCollectionMergeRange')
    expect(panel).toContain('resetCollectionMergeRange')
    expect(panel).toContain('collectionMergePreviewStart')
    expect(panel).toContain('collectionMergePreviewEnd')
    expect(panel).toContain('collectionMergePreviewResetRange')
    ...
    expect(styles).toContain('.vision-collection-merge-preview-range-controls')
    expect(styles).toContain('.vision-collection-merge-preview-reset')
