...
import { buildWebBatchDownloadUrl, formatBytes, formatDuration, formatProgress, getSupportClass, getSupportLabel, isImageMediaItem } from './web-ui'
...
export function LibrarySidebar({ items, visibleItems, tree, selectedId, query, preferences, selectionMode, selectedBatchIds, allVisibleSelected, allSelectedFavorited, onQueryChange, onSelect, onSelectNode, updatePreferences, onEnterSelectionMode, onExitSelectionMode, onToggleBatchSelection, onSelectAllVisible, onClearBatchSelection, onBatchFavorite }: LibrarySidebarProps): ReactElement {
