...
const copy = {
  'zh-CN': {
    ...
    download: { eyebrow: '准备好时再开始', title: '从正确的版本开始。', lede: '页面会为这台电脑推荐一个下载入口；如果需要其他架构，可以展开手动选择。', recommendedLabel: '为这台设备推荐', downloadRecommended: '下载推荐版本', noDownload: '查看可用版本', status: '版本清单已就绪。', retentionLabel: '快速下载', manualTitle: '手动选择平台和架构', manualBody: '如果你要给另一台电脑下载，或需要指定架构，可以在这里选择。', platformLabel: '平台', architectureLabel: '架构', downloadSelected: '下载所选版本', archiveBody: '更早版本保留在 GitHub Releases。', archiveLink: '查看全部版本', detected: '检测到', release: '版本', unavailable: '该架构当前没有安装包，请查看 GitHub Releases。', macos: 'macOS', windows: 'Windows', linux: 'Linux', arm64: 'ARM64', x64: 'x64', privacyTitle: '本地优先的设计', privacyBody: '你的文件、工程、字幕和索引默认保存在本地。', privacyLink: '查看完整隐私政策' },
...
function renderDownloadControls(locale) {
  ...
  const historyLink = document.getElementById('download-history-link')
