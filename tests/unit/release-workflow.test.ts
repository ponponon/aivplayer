...
describe('release workflow source constraints', () => {
  ...
  it('builds and publishes the ARM64 Snap before checking ARM64 release artifacts', () => {
    ...
    expect(snapArm64Workflow).toContain('npx electron-builder --linux snap --arm64 --publish always')
    expect(snapArm64Workflow).toContain('npx electron-builder --linux snap --arm64 --publish never')
