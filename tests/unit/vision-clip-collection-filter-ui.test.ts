...
describe('vision clip collection filter UI wiring', () => {
  it('matches collection titles and tags locally with persistence and saved views', () => {
    ...
    expect(panel).toContain('collectionFilterVisibility')
    expect(panel).toContain('collectionFilterVisibilityLabel')
    expect(panel).toContain('toggleCollectionFlag')
    expect(panel).toContain('setSelectedCollectionFlag')
    expect(panel).toContain('collectionFavoriteAction')
    expect(panel).toContain('collectionArchiveAction')
    expect(panel).toContain('updateVisionClipCollectionFlags')
    expect(panel).toContain('getVisionClipCollectionOperationHistory')
    expect(panel).toContain('getVisionClipCollectionOperationRedoHistory')
    expect(panel).toContain('undoVisionClipCollectionOperation')
    ...
    expect(panel).toContain('summarizeVisionClipCollectionStatuses')
    expect(panel).toContain('collectionStatusSummaryLabel')
    expect(panel).toContain('vision-collection-status-summary')
    ...
    expect(panel).toContain('collectionFilterExcludedTagLabel')
    expect(panel).toContain('collectionFilterRemoveExcludedTag')
    ...
    expect(panel).toContain('updateCollectionFilterTags')
    expect(panel).toContain('clearCollectionFilters')
  ...
  it('keeps filter controls accessible and responsive', () => {
    ...
    expect(panel).toContain('aria-label={app.copy.vision.collectionFilterVisibilityLabel}')
    expect(panel).toContain('aria-pressed={collection.isFavorite}')
    ...
    expect(styles).toContain('.vision-collection-status-card')
    expect(styles).toContain('.vision-collection-status-filter')
    expect(styles).toContain('.vision-collection-operation-undo')
    expect(styles).toContain('.vision-collection-operation-redo')
  })
})
