...
export function EditingGraphicEditor({ graphic, title, textLabel, textPlaceholder, saveLabel, positionLabel, styleLabel, titleStyleLabel, labelStyleLabel, durationLabel, positionLabels, timelineDuration, onUpdate }: EditingGraphicEditorProps): React.ReactElement | null {
  ...
  return <details className="editing-graphic-editor" open data-testid="editing-graphic-editor" onClick={(event) => event.stopPropagation()}>
