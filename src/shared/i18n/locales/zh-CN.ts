  export const zhCN = {
    ...
    editing: {
      captionEffectTitle: '字幕动效', captionEffectNames: { none: '无', highlight: '高亮', 'pill-karaoke': '胶囊卡拉OK', 'word-pop': '逐词弹出', 'kinetic-slam': '重点冲入', 'editorial-emphasis': '编辑强调' }, captionLayoutTitle: '字幕布局', captionLayoutX: '水平位置', captionLayoutY: '垂直位置', captionLayoutWidth: '最大宽度', captionLayoutSize: '字号', captionLayoutReset: '恢复字幕布局', canvasTitle: '画布比例', canvasNames: { source: '原始画布', landscape: '横屏短视频', portrait: '竖屏短视频', square: '正方形' }, exportCapabilityTitle: '字幕烧录能力', exportCapabilityChecking: '正在检查 FFmpeg…', exportCapabilityReady: '当前 FFmpeg 支持字幕烧录', exportCapabilityMissing: '当前 FFmpeg 不包含 subtitles/libass 滤镜；请选择外置字幕，或安装带 libass 的 FFmpeg。',
