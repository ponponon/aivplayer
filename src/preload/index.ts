...
const api = {
  ...
  importVisionClipCollectionTagMetadata: (): Promise<VisionClipCollectionTagMetadataTransferResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_TAG_METADATA_IMPORT),
