...
export type MediaTimelineExportClip = { mediaPath: string; startSeconds: number; endSeconds: number; volume?: number; muted?: boolean; treatment?: EditingClipTreatment; treatmentScale?: number; treatmentAnchor?: EditingTreatmentAnchor; filter?: EditingClipFilter; personMatte?: EditingPersonMatte; personMatteSourceFingerprint?: string; transitionIn?: EditingClipTransition; enterMotion?: EditingGraphicMotion; exitMotion?: EditingGraphicMotion; motionDurationSeconds?: number }
