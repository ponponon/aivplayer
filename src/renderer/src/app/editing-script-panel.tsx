...
export function EditingScriptPanel({
  ...
  return <section ref={panelRef} className="editing-script-panel" data-testid="editing-script-panel" aria-label={title} onMouseUp={handleTextSelection} onKeyDown={(event) => { if (event.key === 'Escape') { setSelectedWords([]); closeWordActions() } }}>
