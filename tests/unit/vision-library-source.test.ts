...
describe('vision library setup', () => {
  ...
  it('keeps the search-to-editing-project path visible in the renderer source', () => {
    ...
    expect(panel).toContain('collapsedCollectionTags')
    expect(panel).toContain('isVisionCollectionTagHiddenByCollapsedAncestor')
    expect(panel).toContain('aria-expanded={!isCollapsed}')
  ...
  it('keeps the reusable Clip Inbox Electron smoke wired into npm scripts', () => {
    ...
    expect(packageJson.scripts?.['smoke:vision-clip-collection-batch-merge']).toContain('smoke-vision-clip-collection-batch-merge.ts')
    ...
    expect(packageJson.scripts?.['smoke:vision-clip-collection-content-undo']).toContain('smoke-vision-clip-collection-content-undo.ts')
    ...
    const batchMergeSmoke = readFileSync(join(projectRoot, 'scripts/smoke-vision-clip-collection-batch-merge.ts'), 'utf8')
    ...
    expect(batchMergeSmoke).toContain('screenshotPath')
    ...
    const contentUndoSmoke = readFileSync(join(projectRoot, 'scripts/smoke-vision-clip-collection-content-undo.ts'), 'utf8')
    expect(contentUndoSmoke).toContain("name: '合并相邻选段'")
    expect(contentUndoSmoke).toContain('contentUndoRedoVerified: true')
    expect(contentUndoSmoke).toContain('persistedRedoAfterReload: true')
    expect(contentUndoSmoke).toContain('invertUndoVerified: true')
    ...
    expect(tagUndoSmoke).toContain('historyFullExport: true')
    ...
    const tagMetadataTransferSmoke = readFileSync(join(projectRoot, 'scripts/smoke-vision-clip-collection-tag-metadata-transfer.ts'), 'utf8')
    expect(packageJson.scripts?.['smoke:vision-clip-collection-tag-metadata-transfer']).toContain('smoke-vision-clip-collection-tag-metadata-transfer.ts')
    expect(tagMetadataTransferSmoke).toContain('exportedCount: exportedManifest.metadata.length')
    expect(tagMetadataTransferSmoke).toContain('importedCount: 1')
    expect(tagMetadataTransferSmoke).toContain('skippedCount: 2')
    expect(tagMetadataTransferSmoke).toContain('overwriteApplied: true')
    expect(tagMetadataTransferSmoke).toContain('keepLocalApplied: true')
    expect(tagMetadataTransferSmoke).toContain('skipApplied: true')
    expect(tagMetadataTransferSmoke).toContain('unusedSkipped: true')
    expect(tagMetadataTransferSmoke).toContain('tagsUnchanged: true')
    const tagFilterSmoke = readFileSync(join(projectRoot, 'scripts/smoke-vision-clip-collection-tag-filter.ts'), 'utf8')
    expect(packageJson.scripts?.['smoke:vision-clip-collection-tag-filter']).toContain('smoke-vision-clip-collection-tag-filter.ts')
    expect(tagFilterSmoke).toContain('queryMatches: 1')
    expect(tagFilterSmoke).toContain('favoritesMatches: 1')
    expect(tagFilterSmoke).toContain('emptyState: true')
    expect(tagFilterSmoke).toContain('dataUnchanged: true')
    const tagSortSmoke = readFileSync(join(projectRoot, 'scripts/smoke-vision-clip-collection-tag-sort.ts'), 'utf8')
    expect(packageJson.scripts?.['smoke:vision-clip-collection-tag-sort']).toContain('smoke-vision-clip-collection-tag-sort.ts')
    expect(tagSortSmoke).toContain('usageSorted: true')
    expect(tagSortSmoke).toContain('favoriteSorted: true')
    expect(tagSortSmoke).toContain('nameSorted: true')
    ...
    expect(packageJson.scripts?.['smoke:vision-clip-collection-tag-collapse']).toContain('smoke-vision-clip-collection-tag-collapse.ts')
    ...
    expect(tagNoteSearchSmoke).toContain('noteMatches: 2')
    expect(tagNoteSearchSmoke).toContain('tagMatch: true')
    expect(tagNoteSearchSmoke).toContain('notesPersisted: true')
    expect(tagNoteSearchSmoke).toContain('dataUnchanged: true')
    ...
    expect(filterSmoke).toContain('tagMatches: 2')
    expect(filterSmoke).toContain('hierarchyTagMatches: 2')
    expect(filterSmoke).toContain('dataUnchanged')
    expect(filterSmoke).toContain('individualTagRemoval: true')
    expect(filterSmoke).toContain('visibleSelectionPreserved: true')
    expect(filterSmoke).toContain('filterPersisted')
    expect(filterSmoke).toContain('favoriteFilterMatches: 1')
    expect(filterSmoke).toContain('archivedFilterMatches: 1')
    expect(filterSmoke).toContain('activeFilterMatches: 2')
    expect(filterSmoke).toContain('集合状态: 收藏 1')
    ...
    expect(filterSmoke).toContain('singleFlagRedoPersisted')
    expect(filterSmoke).toContain('batchFlagRedoPersisted')
