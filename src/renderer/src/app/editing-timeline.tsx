...
export function EditingTimeline(): React.ReactElement | null {
  ...
  return (
    <section className="editing-timeline" data-testid="editing-timeline" aria-label={app.copy.editing.timelineLabel}>
      ...
      {app.editingCaptionReloadConflict ? <EditingCaptionReloadConflict conflict={app.editingCaptionReloadConflict} copy={subtitleReloadCopy} onKeepCurrent={app.keepCurrentEditingCaptions} onForceReload={app.forceReloadEditingCaptions} /> : null}
