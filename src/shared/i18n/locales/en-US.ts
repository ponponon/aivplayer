  export const enUS = {
    ...
    vision: {
      description: 'Sample every video at 3-second intervals and search the local vector index with text or an image.',
      ...
      indexing: (processed: number, total: number) => `Indexing ${processed} / ${total} frames`,
