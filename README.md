...
- 支持 MP4、WebM、MOV、MKV、AVI、FLV、WMV、MPEG-TS、3GP、VOB、MXF、RMVB，以及 MPEG elementary stream、F4V、OGM、NUT、DV、Motion JPEG、Bink、Y4M、H.264/H.265 raw stream 等常见及专业视频格式；浏览器不兼容时可自动转码，支持拖拽打开和播放列表。
