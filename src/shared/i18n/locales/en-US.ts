  export const enUS = {
    ...
    vision: {
      ...
      timings: (planning: string, model: string, frames: string, vector: string, text: string, total: string) => `Time: scan ${planning} · model ${model} · frames ${frames} · vector ${vector} · full text ${text} · total ${total}`,
    ...
    drama: {
      ...
      generationNotStarted: 'This phase only creates a local task contract and does not call a network service. The same queue can be reused when a provider is connected.',
