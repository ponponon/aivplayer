...
export type AsrTranslationServiceTestRequest = { sourceLanguage?: string; targetLanguage: SubtitleTargetLanguageId; provider?: { kind: 'managed' | 'custom'; baseUrl: string | null; model: string | null; apiKey: string | null; translationPrompt?: string | null } }
