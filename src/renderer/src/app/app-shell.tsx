...
export function AppShell(): React.ReactElement {
  ...
  return <div className="app-shell" onDragOver={(event) => event.preventDefault()} onDrop={onDrop}><AppHeader /><main className={`workspace ${app.isSidePanelVisible ? 'with-side-panel' : 'side-panel-collapsed'}`}><PlayerStage /><AppSidePanel /></main><AiWorkflowStatus /><AppOverlays /></div>
}
