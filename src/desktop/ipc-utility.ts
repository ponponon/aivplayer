...
import { openUrlInDefaultBrowser } from './system/url-actions'
...
export function registerUtilityIpc(): void {
  ...
  ipcMain.handle(IPC_CHANNELS.OPEN_EXTERNAL_URL, (_event, url: string): Promise<boolean> => openUrlInDefaultBrowser(url))
