...
export function VisionPanel(): React.ReactElement {
  ...
  const visibleCollections = collections.filter((collection) => {
    ...
    const matchesTag = !collectionFilterTag || collection.tags.some((tag) => isVisionCollectionTagDescendantOrSelf(tag, collectionFilterTag, collectionTagMetadata))
