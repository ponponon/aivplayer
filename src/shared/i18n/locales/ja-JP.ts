  export const jaJP = {
    ...
    editing: {
      ...
      , graphicEnter: '開始アニメーション', graphicExit: '終了アニメーション', graphicMotionDuration: 'アニメーション時間', graphicMotionLabels: { none: 'なし', fade: 'フェード', 'slide-left': '左から', 'slide-right': '右から', rise: '上へ', scale: 'ズーム' }, personMatteTitle: '人物マット', personMatteReady: '準備完了', personMatteMissing: '未インストール', personMatteDownload: 'モデルをダウンロード', personMatteDownloading: 'ダウンロード中…', personMatteModelFile: (path: string) => `モデルディレクトリ：${path}`, personMatteFailure: (message: string) => `ダウンロード失敗：${message}`
    },
    quickSubtitle: {
