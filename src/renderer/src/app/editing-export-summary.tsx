...
export function EditingExportSummary({ clips, durationSeconds, canvasWidth, canvasHeight, durationLabel, clipsLabel, resolutionLabel, audioLabel, muteLabel, volumeLabel }: EditingExportSummaryProps): React.ReactElement {
  ...
  return <div className="editing-export-summary" role="group" aria-label={audioLabel} data-testid="editing-export-summary">
