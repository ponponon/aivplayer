...
- Supports recursive directory scanning, incremental indexing, a background indexing queue, and index progress/phase-duration reporting. Visual indexing starts only after you explicitly submit a manual indexing task; opening a video does not consume indexing resources.
