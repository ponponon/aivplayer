...
import type {
  ...
  VisionClipCollectionBatchMergeRequest,
  VisionClipCollectionBatchMergeResult,
  ...
  VisionClipCollectionContentUpdateRequest,
  VisionClipCollectionContentUpdateResult,
  VisionClipCollectionBatchContentUpdateRequest,
  VisionClipCollectionBatchContentUpdateResult,
  VisionClipCollectionBatchTagsRequest,
  VisionClipCollectionBatchTagsResult,
  VisionClipCollectionTagUpdateRequest,
  VisionClipCollectionTagUpdateResult,
  ...
  VisionClipCollectionTagOperationHistoryEntry,
  VisionClipCollectionTagOperationHistoryDetail,
  VisionClipCollectionTagOperationHistoryPage,
  VisionClipCollectionTagOperationHistoryPageRequest,
  VisionClipCollectionTagOperationBatchRedoResult,
  ...
  VisionClipCollectionOperationHistoryDetail,
  VisionClipCollectionOperationHistoryEntry,
  VisionClipCollectionOperationRedoResult,
  VisionClipCollectionOperationUndoResult,
  VisionClipCollectionOperationBatchRedoResult,
  VisionClipCollectionOperationBatchUndoResult,
  ...
  VisionClipCollectionImportApplyRequest,
  VisionClipCollectionImportApplyResult,
  VisionClipCollectionImportPreviewResult,
  VisionRuntimeStatus,
  ...
  VisionDuplicateMediaScanResult,
  VisionSimilarMediaScanResult,
...
const api = {
  ...
  downloadAppUpdate: (): Promise<AppUpdateState> => ipcRenderer.invoke(IPC_CHANNELS.APP_UPDATE_DOWNLOAD),
  installAppUpdate: (): Promise<void> => ipcRenderer.invoke(IPC_CHANNELS.APP_UPDATE_INSTALL),
  dismissAppUpdate: (): Promise<AppUpdateState> => ipcRenderer.invoke(IPC_CHANNELS.APP_UPDATE_DISMISS),
  skipAppUpdate: (version: string): Promise<AppUpdateState> => ipcRenderer.invoke(IPC_CHANNELS.APP_UPDATE_SKIP, version),
  ...
  scanVisionSimilarMedia: (): Promise<VisionSimilarMediaScanResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_SIMILAR_MEDIA_SCAN),
  cancelVisionSimilarMedia: (): Promise<boolean> => ipcRenderer.invoke(IPC_CHANNELS.VISION_SIMILAR_MEDIA_CANCEL),
  ...
  updateVisionClipCollectionSelections: (request: VisionClipCollectionContentUpdateRequest): Promise<VisionClipCollectionContentUpdateResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_CONTENT_UPDATE, request),
  updateVisionClipCollectionsSelections: (request: VisionClipCollectionBatchContentUpdateRequest): Promise<VisionClipCollectionBatchContentUpdateResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_BATCH_CONTENT_UPDATE, request),
  ...
  renameVisionClipCollection: (request: VisionClipCollectionRenameRequest): Promise<VisionClipCollection | null> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_RENAME, request),
  ...
  updateVisionClipCollectionTags: (request: VisionClipCollectionTagUpdateRequest): Promise<VisionClipCollectionTagUpdateResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_TAGS_UPDATE, request),
  ...
  listVisionClipCollectionTagOperationHistory: (): Promise<VisionClipCollectionTagOperationHistoryEntry[]> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_TAG_OPERATION_HISTORY_LIST),
  listVisionClipCollectionTagOperationHistoryPage: (request: VisionClipCollectionTagOperationHistoryPageRequest = {}): Promise<VisionClipCollectionTagOperationHistoryPage> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_TAG_OPERATION_HISTORY_PAGE, request),
  getVisionClipCollectionTagOperationHistoryDetail: (operationId: string): Promise<VisionClipCollectionTagOperationHistoryDetail | null> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_TAG_OPERATION_HISTORY_DETAIL, operationId),
  ...
  undoVisionClipCollectionTagOperations: (operationIds: string[]): Promise<VisionClipCollectionTagOperationBatchUndoResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_TAG_OPERATION_BATCH_UNDO, operationIds),
  redoVisionClipCollectionTagOperations: (operationIds: string[]): Promise<VisionClipCollectionTagOperationBatchRedoResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_TAG_OPERATION_BATCH_REDO, operationIds),
  ...
  listVisionClipCollectionOperationHistory: (): Promise<VisionClipCollectionOperationHistoryEntry[]> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_OPERATION_HISTORY_LIST),
  getVisionClipCollectionOperationHistoryDetail: (operationId: string): Promise<VisionClipCollectionOperationHistoryDetail | null> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_OPERATION_HISTORY_DETAIL, operationId),
  ...
  undoVisionClipCollectionOperation: (operationId?: string): Promise<VisionClipCollectionOperationUndoResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_OPERATION_UNDO, operationId),
  redoVisionClipCollectionOperation: (operationId?: string): Promise<VisionClipCollectionOperationRedoResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_OPERATION_REDO, operationId),
  undoVisionClipCollectionOperations: (operationIds: string[]): Promise<VisionClipCollectionOperationBatchUndoResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_OPERATION_BATCH_UNDO, operationIds),
  redoVisionClipCollectionOperations: (operationIds: string[]): Promise<VisionClipCollectionOperationBatchRedoResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_OPERATION_BATCH_REDO, operationIds),
  ...
  mergeVisionClipCollections: (request: VisionClipCollectionBatchMergeRequest): Promise<VisionClipCollectionBatchMergeResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_BATCH_MERGE, request),
  ...
  importVisionClipCollectionPreview: (): Promise<VisionClipCollectionImportPreviewResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_IMPORT_PREVIEW),
  applyVisionClipCollectionImport: (request: VisionClipCollectionImportApplyRequest): Promise<VisionClipCollectionImportApplyResult> => ipcRenderer.invoke(IPC_CHANNELS.VISION_CLIP_COLLECTION_IMPORT_APPLY, request),
